...
import com.jzkj.modules.shop.dao.CommentPictureDao;
...
public class CommentPictureServiceImpl  extends ServiceImpl<CommentPictureDao, CommentPictureEntity>  implements CommentPictureService {
    @Autowired
    ...
    public int update(CommentPictureEntity commentPicture) {
        return commentPictureDao.updateById(commentPicture);
    }

    @Override
    public int delete(Integer id) {
        return commentPictureDao.deleteById(id);
    }
