...
import com.jzkj.modules.shop.dao.HelpIssueDao;
import com.jzkj.modules.shop.entity.HelpIssueEntity;
import com.jzkj.modules.shop.service.HelpIssueService;
...
public class HelpIssueServiceImpl  extends ServiceImpl<HelpIssueDao, HelpIssueEntity> implements HelpIssueService {
    @Autowired
    ...
    public int update(HelpIssueEntity helpIssue) {
        return helpIssueDao.updateById(helpIssue);
    }

    @Override
    public int delete(Integer id) {
        return helpIssueDao.deleteById(id);
    }
