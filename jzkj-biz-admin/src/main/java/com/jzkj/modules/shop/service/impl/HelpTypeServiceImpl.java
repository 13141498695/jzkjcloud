...
import com.jzkj.modules.shop.dao.HelpTypeDao;
import com.jzkj.modules.shop.entity.CartEntity;
import com.jzkj.modules.shop.entity.HelpTypeEntity;
import com.jzkj.modules.shop.service.HelpTypeService;
...
public class HelpTypeServiceImpl  extends ServiceImpl<CartDao, CartEntity>  implements HelpTypeService {
    @Autowired
    ...
    public int update(HelpTypeEntity helpType) {
        return helpTypeDao.updateById(helpType);
    }

    @Override
    public int delete(Integer id) {
        return helpTypeDao.deleteById(id);
    }
